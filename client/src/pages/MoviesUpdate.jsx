...
class MoviesUpdate extends Component {
    ...
    handleChangeInputRating = async event => {
        const ratting = event.target.validity.valid ? event.target.value : this.state.ratting
    ...
    componentDidMount = async () =>{
        ...
        this.setState({
            ...
            ratting: movie.data.data.ratting,
